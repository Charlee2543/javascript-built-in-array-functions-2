...
function updateCarCollection(carBrand) {
  // Start coding here
  return carCollection.includes(carBrand) ? `${carBrand} has already existed in the 1 position of car collection.`:`${carBrand} new car collection is : toyota,fiat,honda,bmw,audi.`;
}
